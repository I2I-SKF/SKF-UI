...
export class CheckTokenComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.apicall.areWeResetting = params['reset'] ? true :false;
    });
    ...
    this.apicall
      .managePasswords_ValidateToken(jsondata)
      .subscribe((res: any) => {
        if (res.errorMessage) {
          ...
          console.log('are we resetting',this.apicall.areWeResetting , typeof this.apicall.areWeResetting);
          

          if (this.apicall.areWeResetting) {
